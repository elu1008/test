...
class AllInOne {
    ...
    public $ServiceGetURL = 'ServiceGetURL';
    ...
    function QueryTradeInfo() {
        return $arFeedback = QueryTradeInfo::CheckOut(array_merge($this->Query,array("MerchantID" => $this->MerchantID)) ,$this->HashKey ,$this->HashIV ,$this->ServiceGetURL) ;
    }
...
abstract class Aio
{
    ...
    static protected function ServerPost($parameters ,$ServiceURL) {
        $ch = curl_init();
